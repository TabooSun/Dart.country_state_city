...
const khm = Country(
    ...
    states: [
      ...
      State(id: 3976, name: 'Battambang Province', stateCode: '2', cities: [
        City(
            id: 64940,
            name: 'Battambang',
      ...
      State(id: 3991, name: 'Kampong Cham Province', stateCode: '3', cities: [
        City(
            id: 64941,
            name: 'Cheung Prey',
      ...
      State(id: 3988, name: 'Kampong Speu Province', stateCode: '5', cities: [
        City(
            id: 64946,
            name: 'Kampong Speu',
      ...
      State(id: 3981, name: 'Kampot Province', stateCode: '7', cities: [
        City(
            id: 64935,
            name: 'Angkor Chey',
      ...
      State(id: 3983, name: 'Kandal Province', stateCode: '8', cities: [
        City(
            id: 64965,
            name: 'Krŏng Ta Khmau',
      ...
      State(id: 3978, name: 'Kep Province', stateCode: '23', cities: [
        City(
            id: 64961,
            name: 'Krong Kep',
      ...
      State(id: 3982, name: 'Koh Kong Province', stateCode: '9', cities: [
        City(
            id: 64957,
            name: 'Koh Kong',
      ...
      State(id: 3986, name: 'Kratié Province', stateCode: '10', cities: [
        City(
            id: 64958,
            name: 'Kracheh',
      ...
      State(id: 3985, name: 'Mondulkiri Province', stateCode: '11', cities: [
        City(
            id: 64964,
      ...
      State(id: 3980, name: 'Pailin Province', stateCode: '24', cities: [
        City(
            id: 64956,
            name: 'Khan Sala Krau',
      ...
      State(id: 3994, name: 'Phnom Penh', stateCode: '12', cities: [
        City(
            id: 64949,
            name: 'Khan 7 Makara',
      ...
      State(id: 3973, name: 'Preah Vihear Province', stateCode: '13', cities: [
        City(
            id: 64977,
            name: 'Sangkom Thmei',
      ...
      State(id: 3974, name: 'Prey Veng Province', stateCode: '14', cities: [
        City(
            id: 64972,
            name: 'Prey Veng',
      ...
      State(id: 3977, name: 'Pursat Province', stateCode: '15', cities: [
        City(
            id: 64936,
            name: 'Bakan',
      ...
      State(id: 3990, name: 'Ratanakiri Province', stateCode: '16', cities: [
        City(
            id: 64937,
            name: 'Banlung',
      ...
      State(id: 3992, name: 'Siem Reap Province', stateCode: '17', cities: [
        City(
            id: 64979,
            name: 'Siem Reap',
      ...
      State(id: 3989, name: 'Sihanoukville Province', stateCode: '18', cities: [
        City(
            id: 64980,
            name: 'Sihanoukville',
      ...
      State(id: 3993, name: 'Stung Treng Province', stateCode: '19', cities: [
        City(
            id: 65020,
            name: 'Srŏk Srêsén',
      ...
      State(id: 3972, name: 'Svay Rieng Province', stateCode: '20', cities: [
        City(
            id: 65021,
      ...
      State(id: 3975, name: 'Takéo Province', stateCode: '21', cities: [
        City(
            id: 64963,
