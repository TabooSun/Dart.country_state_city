...
const yem = Country(
    ...
    states: [
      State(id: 1242, name: '\'Adan Governorate', stateCode: 'AD', cities: [
        City(
            id: 130669,
            name: 'Aden',
      ...
      State(id: 1250, name: '\'Amran Governorate', stateCode: 'AM', cities: [
        City(
            id: 131013,
            name: '‘Amrān',
      ...
      State(id: 1237, name: 'Abyan Governorate', stateCode: 'AB', cities: [
        City(
            id: 130673,
            name: 'Ahwar',
      ...
      State(id: 1240, name: 'Al Bayda\' Governorate', stateCode: 'BA', cities: [
        City(
            id: 130676,
            name: 'Al A\'rsh',
      ...
      State(id: 1243, name: 'Al Jawf Governorate', stateCode: 'JA', cities: [
        City(
            id: 130758,
            name: 'Al ‘Inān',
      ...
      State(id: 1251, name: 'Al Mahrah Governorate', stateCode: 'MR', cities: [
        City(
            id: 130687,
            name: 'Al Ghaydah',
      ...
      State(id: 1235, name: 'Al Mahwit Governorate', stateCode: 'MW', cities: [
        City(
            id: 130705,
            name: 'Al Khabt',
      ...
      State(id: 1246, name: 'Dhamar Governorate', stateCode: 'DH', cities: [
        City(
            id: 131014,
            name: '‘Ans',
      ...
      State(id: 1238, name: 'Hadhramaut Governorate', stateCode: 'HD', cities: [
        City(
            id: 130666,
            name: 'Ad Dis',
      ...
      State(id: 1244, name: 'Hajjah Governorate', stateCode: 'HJ', cities: [
        City(
            id: 130664,
            name: 'Abs',
      ...
      State(id: 1233, name: 'Ibb Governorate', stateCode: 'IB', cities: [
        City(
            id: 130759,
            name: 'Al ‘Udayn',
      ...
      State(id: 1245, name: 'Lahij Governorate', stateCode: 'LA', cities: [
        City(
            id: 130675,
            name: 'Al  Hawtah',
      ...
      State(id: 1234, name: 'Ma\'rib Governorate', stateCode: 'MA', cities: [
        City(
            id: 130677,
            name: 'Al Abdiyah',
      ...
      State(id: 1248, name: 'Raymah Governorate', stateCode: 'RA', cities: [
        City(
            id: 130701,
            name: 'Al Jabin',
      ...
      State(id: 1249, name: 'Saada Governorate', stateCode: 'SD', cities: [
        City(
            id: 130684,
            name: 'Al Dhaher',
      ...
      State(id: 1232, name: 'Sana\'a', stateCode: 'SA', cities: []),
      State(id: 1236, name: 'Sana\'a Governorate', stateCode: 'SN', cities: [
        City(
            id: 130696,
      ...
      State(id: 1247, name: 'Shabwah Governorate', stateCode: 'SH', cities: [
        City(
            id: 130674,
            name: 'Ain',
      ...
      State(id: 1239, name: 'Socotra Governorate', stateCode: 'SU', cities: [
        City(
            id: 130848,
            name: 'Hadibu',
      ...
      State(id: 1231, name: 'Ta\'izz Governorate', stateCode: 'TA', cities: [
        City(
            id: 130708,
            name: 'Al Ma\'afer',
