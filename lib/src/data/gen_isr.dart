...
const isr = Country(
    ...
    states: [
      State(id: 1367, name: 'Central District', stateCode: 'M', cities: [
        City(
            id: 57446,
            name: 'Bet Dagan',
      ...
      State(id: 1369, name: 'Haifa District', stateCode: 'HA', cities: [
        City(
            id: 57440,
            name: 'Atlit',
      ...
      State(id: 1370, name: 'Jerusalem District', stateCode: 'JM', cities: [
        City(
            id: 57434,
            name: 'Abū Ghaush',
      ...
      State(id: 1366, name: 'Northern District', stateCode: 'Z', cities: [
        City(
            id: 57581,
            name: '‘Eilabun',
      ...
      State(id: 1368, name: 'Southern District', stateCode: 'D', cities: [
        City(
            id: 57582,
            name: '‘En Boqeq',
      ...
      State(id: 1371, name: 'Tel Aviv District', stateCode: 'TA', cities: [
        City(
            id: 57441,
            name: 'Azor',
