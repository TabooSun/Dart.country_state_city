...
const chn = Country(
    ...
    states: [
      State(id: 2251, name: 'Anhui', stateCode: 'AH', cities: [
        City(
            id: 19284,
            name: 'Anqing',
      ...
      State(id: 2257, name: 'Beijing', stateCode: 'BJ', cities: [
        City(
            id: 19332,
            name: 'Beijing',
      ...
      State(id: 2271, name: 'Chongqing', stateCode: 'CQ', cities: [
        City(
            id: 19327,
            name: 'Beibei',
      ...
      State(id: 2248, name: 'Fujian', stateCode: 'FJ', cities: [
        City(
            id: 19296,
            name: 'Badu',
      ...
      State(id: 2275, name: 'Gansu', stateCode: 'GS', cities: [
        City(
            id: 19309,
            name: 'Baiyin',
      ...
      State(id: 2279, name: 'Guangdong', stateCode: 'GD', cities: [
        City(
            id: 19278,
            name: 'Anbu',
      ...
      State(id: 2261, name: 'Guizhou', stateCode: 'GZ', cities: [
        City(
            id: 19288,
            name: 'Anshun',
        ...
        City(
            id: 19630,
            name: 'Hongzhou',
            latitude: '26.12583000',
            longitude: '109.40889000'),
        City(
            id: 19666,
            name: 'Huaqiu',
      ...
      State(id: 2273, name: 'Hainan', stateCode: 'HI', cities: [
        City(
            id: 19321,
            name: 'Basuo',
      ...
      State(id: 2280, name: 'Hebei', stateCode: 'HE', cities: [
        City(
            id: 19314,
            name: 'Baoding',
      ...
      State(id: 2265, name: 'Heilongjiang', stateCode: 'HL', cities: [
        City(
            id: 19272,
            name: 'Acheng',
      ...
      State(id: 2259, name: 'Henan', stateCode: 'HA', cities: [
        City(
            id: 19290,
            name: 'Anyang',
      ...
      State(id: 2267, name: 'Hong Kong', stateCode: 'HK', cities: []),
      State(id: 2274, name: 'Hubei', stateCode: 'HB', cities: [
        City(
            id: 19282,
            name: 'Anlu',
      ...
      State(id: 2258, name: 'Hunan', stateCode: 'HN', cities: [
        City(
            id: 19280,
            name: 'Anjiang',
      ...
      State(id: 2269, name: 'Inner Mongolia', stateCode: 'NM', cities: [
        City(
            id: 19318,
            name: 'Baotou',
      ...
      State(id: 2250, name: 'Jiangsu', stateCode: 'JS', cities: []),
      State(id: 2256, name: 'Jiangxi', stateCode: 'JX', cities: [
        City(
            id: 19367,
            name: 'Changleng',
      ...
      State(id: 2253, name: 'Jilin', stateCode: 'JL', cities: [
        City(
            id: 19298,
            name: 'Baicheng',
      ...
      State(id: 2276, name: 'Keelung', stateCode: 'TW-KEE', cities: []),
      State(id: 2268, name: 'Liaoning', stateCode: 'LN', cities: [
        City(
            id: 19287,
            name: 'Anshan',
      ...
      State(id: 2266, name: 'Macau', stateCode: 'MO', cities: []),
      State(
          id: 2262,
      ...
      State(id: 2270, name: 'Qinghai', stateCode: 'QH', cities: [
        City(
            id: 19448,
            name: 'Delingha',
      ...
      State(id: 2272, name: 'Shaanxi', stateCode: 'SN', cities: [
        City(
            id: 19281,
            name: 'Ankang',
      ...
      State(id: 2252, name: 'Shandong', stateCode: 'SD', cities: [
        City(
            id: 19286,
            name: 'Anqiu',
      ...
      State(id: 2249, name: 'Shanghai', stateCode: 'SH', cities: [
        City(
            id: 20063,
            name: 'Shanghai',
      ...
      State(id: 2254, name: 'Shanxi', stateCode: 'SX', cities: [
        City(
            id: 19378,
            name: 'Changzhi',
      ...
      State(id: 2277, name: 'Sichuan', stateCode: 'SC', cities: [
        City(
            id: 19271,
      ...
      State(id: 2263, name: 'Xinjiang', stateCode: 'XJ', cities: [
        City(
            id: 19273,
            name: 'Ailan Mubage',
      ...
      State(id: 2260, name: 'Yunnan', stateCode: 'YN', cities: [
        City(
            id: 19409,
      ...
      State(id: 2247, name: 'Zhejiang', stateCode: 'ZJ', cities: [
        City(
            id: 19453,
            name: 'Deqing',
