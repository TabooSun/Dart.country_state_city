...
const prk = Country(
    ...
    states: [
      State(id: 3998, name: 'Chagang Province', stateCode: '04', cities: [
        City(
            id: 65186,
            name: 'Changgang-gun',
      ...
      State(id: 3999, name: 'Kangwon Province', stateCode: '07', cities: [
        City(
            id: 65181,
            name: 'Anbyŏn-ŭp',
      ...
      State(id: 4002, name: 'North Pyongan Province', stateCode: '03', cities: [
        City(
            id: 65191,
            name: 'Chŏngju',
      ...
      State(id: 4005, name: 'Pyongyang', stateCode: '01', cities: [
        City(
            id: 65190,
            name: 'Chunghwa',
      ...
      State(id: 4001, name: 'Rason', stateCode: '13', cities: [
        City(
            id: 65246,
            name: 'Sŏnbong',
      ...
      State(id: 3996, name: 'Ryanggang Province', stateCode: '10', cities: [
        City(
            id: 65201,
            name: 'Hyesan',
      ...
      State(id: 3997, name: 'South Pyongan Province', stateCode: '02', cities: [
        City(
            id: 65182,
            name: 'Anju',
