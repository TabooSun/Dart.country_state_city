...
const kor = Country(
    ...
    states: [
      State(id: 3860, name: 'Busan', stateCode: '26', cities: [
        City(
            id: 65276,
            name: 'Buk-gu',
      ...
      State(id: 3846, name: 'Daegu', stateCode: '27', cities: [
        City(
            id: 65300,
            name: 'Daegu',
      ...
      State(id: 3850, name: 'Daejeon', stateCode: '30', cities: [
        City(
            id: 65301,
            name: 'Daejeon',
      ...
      State(id: 3862, name: 'Gangwon Province', stateCode: '42', cities: [
        City(
            id: 65293,
            name: 'Cheorwon-gun',
      ...
      State(id: 3858, name: 'Gwangju', stateCode: '29', cities: [
        City(
            id: 65362,
            name: 'Gwangju',
      ...
      State(id: 3847, name: 'Gyeonggi Province', stateCode: '41', cities: [
        City(
            id: 65262,
            name: 'Ansan-si',
      ...
      State(id: 3848, name: 'Incheon', stateCode: '28', cities: [
        City(
            id: 65277,
            name: 'Bupyeong-gu',
      ...
      State(id: 3853, name: 'Jeju', stateCode: '49', cities: [
        City(
            id: 65317,
            name: 'Gaigeturi',
      ...
      State(id: 3851, name: 'North Jeolla Province', stateCode: '45', cities: [
        City(
            id: 65273,
            name: 'Buan-gun',
      ...
      State(id: 3861, name: 'Sejong City', stateCode: '50', cities: [
        City(
            id: 65483,
            name: 'Sejong',
      ...
      State(id: 3849, name: 'Seoul', stateCode: '11', cities: [
        City(
            id: 65306,
            name: 'Dobong-gu',
      ...
      State(id: 3856, name: 'South Jeolla Province', stateCode: '46', cities: [
        City(
            id: 65267,
            name: 'Beolgyo',
      ...
      State(id: 3852, name: 'Ulsan', stateCode: '31', cities: [
        City(
            id: 65275,
            name: 'Buk-gu',
