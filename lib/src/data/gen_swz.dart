...
const swz = Country(
    ...
    states: [
      State(id: 969, name: 'Hhohho District', stateCode: 'HH', cities: [
        City(
            id: 105084,
            name: 'Bulembu',
      ...
      State(id: 970, name: 'Lubombo District', stateCode: 'LU', cities: [
        City(
            id: 105083,
            name: 'Big Bend',
      ...
      State(id: 968, name: 'Manzini District', stateCode: 'MA', cities: [
        City(
            id: 105082,
            name: 'Bhunya',
      ...
      State(id: 971, name: 'Shiselweni District', stateCode: 'SH', cities: [
        City(
            id: 105088,
            name: 'Hlatikulu',
