...
const arm = Country(
    ...
    states: [
      State(id: 2023, name: 'Aragatsotn Region', stateCode: 'AG', cities: [
        City(
            id: 286,
            name: 'Agarakavan',
      ...
      State(id: 2024, name: 'Ararat Province', stateCode: 'AR', cities: [
        City(
            id: 282,
            name: 'Abovyan',
      ...
      State(id: 2026, name: 'Armavir Region', stateCode: 'AV', cities: [
        City(
            id: 289,
            name: 'Aghavnatun',
      ...
      State(id: 2028, name: 'Gegharkunik Province', stateCode: 'GR', cities: [
        City(
            id: 296,
            name: 'Akunk’',
      ...
      State(id: 2033, name: 'Kotayk Region', stateCode: 'KT', cities: [
        City(
            id: 281,
            name: 'Abovyan',
      ...
      State(id: 2029, name: 'Lori Region', stateCode: 'LO', cities: [
        City(
            id: 283,
            name: 'Agarak',
      ...
      State(id: 2031, name: 'Shirak Region', stateCode: 'SH', cities: [
        City(
            id: 291,
            name: 'Akhuryan',
      ...
      State(id: 2027, name: 'Syunik Province', stateCode: 'SU', cities: [
        City(
            id: 284,
            name: 'Agarak',
      ...
      State(id: 2032, name: 'Tavush Region', stateCode: 'TV', cities: [
        City(
            id: 312,
            name: 'Archis',
      ...
      State(id: 2025, name: 'Vayots Dzor Region', stateCode: 'VD', cities: [
        City(
            id: 285,
            name: 'Agarakadzor',
      ...
      State(id: 2030, name: 'Yerevan', stateCode: 'ER', cities: [
        City(
            id: 304,
            name: 'Arabkir',
