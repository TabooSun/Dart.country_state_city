...
const afg = Country(
    ...
    states: [
      State(id: 3901, name: 'Badakhshan', stateCode: 'BDS', cities: [
        City(
            id: 52,
            name: 'Ashkāsham',
      ...
      State(id: 3871, name: 'Badghis', stateCode: 'BDG', cities: [
        City(
            id: 72,
            name: 'Ghormach',
      ...
      State(id: 3875, name: 'Baghlan', stateCode: 'BGL', cities: [
        City(
            id: 54,
            name: 'Baghlān',
      ...
      State(id: 3884, name: 'Balkh', stateCode: 'BAL', cities: [
        City(
            id: 55,
            name: 'Balkh',
      ...
      State(id: 3872, name: 'Bamyan', stateCode: 'BAM', cities: [
        City(
            id: 57,
            name: 'Bāmyān',
      ...
      State(id: 3892, name: 'Daykundi', stateCode: 'DAY', cities: [
        City(
            id: 102,
            name: 'Nīlī',
      ...
      State(id: 3899, name: 'Farah', stateCode: 'FRA', cities: [
        City(
            id: 66,
            name: 'Farah',
      ...
      State(id: 3889, name: 'Faryab', stateCode: 'FYB', cities: [
        City(
            id: 50,
            name: 'Andkhoy',
      ...
      State(id: 3870, name: 'Ghazni', stateCode: 'GHA', cities: [
        City(
            id: 71,
            name: 'Ghazni',
      ...
      State(id: 3888, name: 'Ghōr', stateCode: 'GHO', cities: [
        City(
            id: 67,
            name: 'Fayrōz Kōh',
      ...
      State(id: 3873, name: 'Helmand', stateCode: 'HEL', cities: [
        City(
            id: 141,
      ...
      State(id: 3887, name: 'Herat', stateCode: 'HER', cities: [
        City(
            id: 60,
            name: 'Chahār Burj',
      ...
      State(id: 3886, name: 'Jowzjan', stateCode: 'JOW', cities: [
        City(
            id: 136,
            name: 'Āqchah',
      ...
      State(id: 3902, name: 'Kabul', stateCode: 'KAB', cities: [
        City(
            id: 79,
            name: 'Kabul',
      ...
      State(id: 3890, name: 'Kandahar', stateCode: 'KAN', cities: [
        City(
            id: 81,
            name: 'Kandahār',
      ...
      State(id: 3879, name: 'Kapisa', stateCode: 'KAP', cities: [
        City(
            id: 124,
            name: 'Sidqābād',
      ...
      State(id: 3878, name: 'Khost', stateCode: 'KHO', cities: [
        City(
            id: 87,
            name: 'Khōst',
      ...
      State(id: 3876, name: 'Kunar', stateCode: 'KNR', cities: [
        City(
            id: 51,
            name: 'Asadabad',
      ...
      State(id: 3900, name: 'Kunduz Province', stateCode: 'KDZ', cities: [
        City(
            id: 64,
            name: 'Dasht-e Archī',
      ...
      State(id: 3891, name: 'Laghman', stateCode: 'LAG', cities: [
        City(
            id: 98,
            name: 'Mehtar Lām',
      ...
      State(id: 3897, name: 'Logar', stateCode: 'LOG', cities: [
        City(
            id: 56,
            name: 'Baraki Barak',
      ...
      State(id: 3882, name: 'Nangarhar', stateCode: 'NAN', cities: [
        City(
            id: 58,
            name: 'Bāsawul',
      ...
      State(id: 3896, name: 'Nimruz', stateCode: 'NIM', cities: [
        City(
            id: 86,
            name: 'Khāsh',
      ...
      State(id: 3880, name: 'Nuristan', stateCode: 'NUR', cities: [
        City(
            id: 107,
            name: 'Pārūn',
      ...
      State(id: 3894, name: 'Paktia', stateCode: 'PIA', cities: [
        City(
            id: 69,
            name: 'Gardez',
      ...
      State(id: 3877, name: 'Paktika', stateCode: 'PKA', cities: [
        City(
            id: 120,
            name: 'Saṟōbī',
      ...
      State(id: 3881, name: 'Panjshir', stateCode: 'PAN', cities: [
        City(
            id: 59,
            name: 'Bāzārak',
      ...
      State(id: 3895, name: 'Parwan', stateCode: 'PAR', cities: [
        City(
            id: 61,
            name: 'Charikar',
      ...
      State(id: 3883, name: 'Samangan', stateCode: 'SAM', cities: [
        City(
            id: 53,
            name: 'Aībak',
      ...
      State(id: 3885, name: 'Sar-e Pol', stateCode: 'SAR', cities: [
        City(
            id: 62,
            name: 'Chīras',
      ...
      State(id: 3893, name: 'Takhar', stateCode: 'TAK', cities: [
        City(
            id: 137,
            name: 'Ārt Khwājah',
      ...
      State(id: 3898, name: 'Urozgan', stateCode: 'URU', cities: [
        City(
            id: 127,
            name: 'Tarinkot',
      ...
      State(id: 3874, name: 'Zabul', stateCode: 'ZAB', cities: [
        City(
            id: 109,
            name: 'Qalāt',
