...
const lbn = Country(
    ...
    states: [
      State(id: 2285, name: 'Akkar Governorate', stateCode: 'AK', cities: [
        City(
            id: 65939,
            name: 'Caza de Aakkar',
      ...
      State(id: 2286, name: 'Beirut Governorate', stateCode: 'BA', cities: [
        City(
            id: 65936,
            name: 'Beirut',
      ...
      State(id: 2287, name: 'Beqaa Governorate', stateCode: 'BI', cities: [
        City(
            id: 65930,
            name: 'Aanjar',
      ...
      State(id: 2288, name: 'Nabatieh Governorate', stateCode: 'NA', cities: [
        City(
            id: 65931,
            name: 'Ain Ebel',
      ...
      State(id: 2284, name: 'North Governorate', stateCode: 'AS', cities: [
        City(
            id: 65934,
            name: 'Batroûn',
      ...
      State(id: 2281, name: 'South Governorate', stateCode: 'JA', cities: [
        City(
            id: 65944,
            name: 'En Nâqoûra',
