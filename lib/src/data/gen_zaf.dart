...
const zaf = Country(
    ...
    states: [
      State(id: 938, name: 'Eastern Cape', stateCode: 'EC', cities: [
        City(
            id: 131015,
            name: 'Adelaide',
      ...
      State(id: 932, name: 'Free State', stateCode: 'FS', cities: [
        City(
            id: 131021,
            name: 'Allanridge',
      ...
      State(id: 936, name: 'Gauteng', stateCode: 'GP', cities: [
        City(
            id: 131017,
            name: 'Alberton',
      ...
      State(id: 935, name: 'KwaZulu-Natal', stateCode: 'KZN', cities: [
        City(
            id: 131022,
      ...
      State(id: 933, name: 'Limpopo', stateCode: 'LP', cities: [
        City(
            id: 131040,
            name: 'Bochum',
      ...
      State(id: 937, name: 'Mpumalanga', stateCode: 'MP', cities: [
        City(
            id: 131026,
            name: 'Balfour',
      ...
      State(id: 934, name: 'North West', stateCode: 'NW', cities: [
        City(
            id: 131039,
            name: 'Bloemhof',
      ...
      State(id: 931, name: 'Northern Cape', stateCode: 'NC', cities: [
        City(
            id: 131029,
            name: 'Barkly West',
      ...
      State(id: 939, name: 'Western Cape', stateCode: 'WC', cities: [
        City(
            id: 131016,
            name: 'Albertina',
