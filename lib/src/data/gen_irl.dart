...
const irl = Country(
    ...
    states: [
      State(id: 1087, name: 'Connacht', stateCode: 'C', cities: [
        City(
            id: 57082,
            name: 'Athenry',
      ...
      State(id: 1095, name: 'County Carlow', stateCode: 'CW', cities: []),
      State(id: 1088, name: 'County Cavan', stateCode: 'CN', cities: []),
      State(id: 1091, name: 'County Clare', stateCode: 'CE', cities: []),
      State(id: 1074, name: 'County Cork', stateCode: 'CO', cities: []),
      State(id: 1071, name: 'County Donegal', stateCode: 'DL', cities: []),
      State(id: 1072, name: 'County Dublin', stateCode: 'D', cities: []),
      State(id: 1079, name: 'County Galway', stateCode: 'G', cities: []),
      State(id: 1077, name: 'County Kerry', stateCode: 'KY', cities: []),
      State(id: 1082, name: 'County Kildare', stateCode: 'KE', cities: []),
      State(id: 1090, name: 'County Kilkenny', stateCode: 'KK', cities: []),
      State(id: 1096, name: 'County Laois', stateCode: 'LS', cities: []),
      State(id: 1094, name: 'County Limerick', stateCode: 'LK', cities: []),
      State(id: 1076, name: 'County Longford', stateCode: 'LD', cities: []),
      State(id: 1083, name: 'County Louth', stateCode: 'LH', cities: []),
      State(id: 1084, name: 'County Mayo', stateCode: 'MO', cities: []),
      State(id: 1092, name: 'County Meath', stateCode: 'MH', cities: []),
      State(id: 1075, name: 'County Monaghan', stateCode: 'MN', cities: []),
      State(id: 1078, name: 'County Offaly', stateCode: 'OY', cities: []),
      State(id: 1081, name: 'County Roscommon', stateCode: 'RN', cities: []),
      State(id: 1070, name: 'County Sligo', stateCode: 'SO', cities: []),
      State(id: 1069, name: 'County Tipperary', stateCode: 'TA', cities: []),
      State(id: 1089, name: 'County Waterford', stateCode: 'WD', cities: []),
      State(id: 1097, name: 'County Westmeath', stateCode: 'WH', cities: []),
      State(id: 1093, name: 'County Wexford', stateCode: 'WX', cities: []),
      State(id: 1085, name: 'County Wicklow', stateCode: 'WW', cities: []),
      State(id: 1073, name: 'Leinster', stateCode: 'L', cities: [
        City(
            id: 57063,
            name: 'Abbeyleix',
      ...
      State(id: 1080, name: 'Munster', stateCode: 'M', cities: [
        City(
            id: 57062,
            name: 'Abbeyfeale',
      ...
      State(id: 1086, name: 'Ulster', stateCode: 'U', cities: [
        City(
            id: 57066,
            name: 'An Cabhán',
